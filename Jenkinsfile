...
pipeline {
    ...
    stages {
        ...
        stage("commit version update") {
            ...
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: 'github-access-token', passwordVariable: 'PASS', usernameVariable: 'USER')]) {
                        ...
                        sh "git remote set-url origin https://${PASS}@github.com/JulienAvezou/devops-bootcamp-project-1.git"         
                        sh 'git add .'
